                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" id="inputDesignation">
                                                    <div class="form-text">Provide teacher designation.</div>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="inputPhone" class="form-label">Phone number</label>
                                                    <input type="number" class="form-control form-control-sm" id="inputPhone">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="file" class="form-control form-control-sm" id="image_file" name="image_file">
                                                </div>
                                            </form>
                                        </div>
