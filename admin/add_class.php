                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdropEditClass"><i class="fas fa-edit"></i> Class</button>
                                        <button class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdropEditSection"><i class="fas fa-edit"></i> Section</button>
