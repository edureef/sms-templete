                    ...
                    <div class="card-body">
                        <form method="POST" action="">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="inputBirthDate3">
                                </div>
                            </div>
                            <fieldset>
                                <div class="row mb-3">
                            ...
                            <div class="row justify-content-center">
                                <button type="submit" class="mt-3 btn btn-primary col-sm-8">Add Student</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-4">
                                <button type="button" class="btn btn-success w-100">Filter</button>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-sm-12">
